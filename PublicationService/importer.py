...
from PublicationService.model import EnergySource, EnergyReport
from PublicationService.dataobjects import EnergyConsumption, EnergyMix, Population, EnergyAccess
